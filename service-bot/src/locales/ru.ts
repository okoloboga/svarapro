...
Используйте /help для списка команд.`,
  ...
  errors: {
    ...
    invalidPassword: '❌ Пароль должен содержать только буквы и цифры (6-20 символов)'
  },
  ...
  success: {
    ...
    passwordCreated: '✅ Пароль создан! Теперь вы можете использовать /admin для входа.',
  ...
  admin: {
    ...
    createPassword: '🔐 Создайте новый пароль администратора (только буквы и цифры, 6-20 символов):',
    wrongPassword: '❌ Неверный пароль',
    alreadyLoggedIn: '✅ Вы уже авторизованы как администратор.',
    notInAdminList: '❌ Вы не в списке администраторов.',
    firstTimeAdmin: '🔐 Добро пожаловать! Это ваш первый вход. Создайте пароль администратора:',
    back: '⬅️ Назад',
    search: '🔍 Поиск',
    next: '➡️ Далее',
    prev: '⬅️ Назад',
