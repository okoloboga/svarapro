...
export function AddWallet() {
  ...
  return (
    <div className="bg-primary min-h-screen flex flex-col items-center pt-4 px-4">
      ...
      <div className="bg-black bg-opacity-30 rounded-lg px-4 w-[90vw] flex items-center mb-4 h-[53px]">
        <input
          type="text"
          value={address}
      ...
      <div className="bg-red-900 bg-opacity-30 rounded-lg p-3 mb-4 w-[90vw] flex items-center text-left">
