...
export function LoadingPage({ isLoading }: { isLoading: boolean }) {
  return (
    ...
    >
      ...
      >
        {/* Main Logo - Большая картинка посередине */}
        <div
          style={{
            position: 'absolute',
            width: '376px',
            height: '270px',
            left: 'calc(50% - 376px/2 - 0.5px)',
            top: '248px',
            backgroundImage: 'url(/assets/main_logo.png)',
        ...
        {/* Group 1123 - Маленький SVG "18+" внизу */}
        <div
          style={{
            position: 'absolute',
            width: '20px',
