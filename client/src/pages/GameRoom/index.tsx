...
const getPositionStyle = (position: number): React.CSSProperties => {
  switch (position) {
    case 1: return { top: '-20%', left: '50%', transform: 'translateX(-50%)' }; // Top
    case 2: return { top: '20%', right: '10%', transform: 'translateY(-50%)' }; // Right-Top
    case 3: return { bottom: '20%', right: '10%', transform: 'translateY(50%)' }; // Right-Bottom
    case 4: return { bottom: '0%', left: '50%', transform: 'translateX(-50%)' }; // Bottom
    case 5: return { bottom: '20%', left: '10%', transform: 'translateY(50%)' }; // Left-Bottom
    case 6: return { top: '20%', left: '10%', transform: 'translateY(-50%)' }; // Left-Top
    default: return {};
  }
};
