  ...
  return (
    <div className={spotClasses} style={containerStyle}>
      <div className="relative">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative" style={{ width: `${nameWidth}px`, height: `${nameHeight}px` }}>
                ...
                >
                  ...
                  <div
                    style={{ width: `${66 * scale}px`, height: `${1 * scale}px`, backgroundColor: 'rgba(255, 255, 255, 0.07)' }}
                  ></div>
                  <div
                    className="font-bold"
        ...
        {!hasFolded && (
          <div className="absolute top-1/2 right-0 transform -translate-y-1/2 z-30" style={{ top: '30%', left: '50px' }}>
