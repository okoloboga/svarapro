...
export function SlidePanel({ isOpen }: SlidePanelProps) {
  ...
  return (
    <div
      className="bg-gradient-to-b from-[#36333B] via-[#46434B] to-[#48454D] shadow-lg rounded-b-lg p-2 mx-auto w-[336px]"
      style={{ boxShadow: '0px 5.5px 10px rgba(0, 0, 0, 0.25)', borderRadius: '0 0 8px 8px' }}
    >
      <p className="text-white text-center mb-2">Отображать только</p>
      <div
        className="bg-gradient-to-b from-[#36333B] via-[#46434B] to-[#48454D] p-1 rounded-lg"
        style={{ boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)', borderRadius: '15px', width: '320px', margin: '0 auto', maxWidth: '320px' }}
      >
        <div style={{ position: 'relative', height: '37px', width: '100%' }}>
          <Slider
            range
            min={0}
            max={1000000}
            ...
            railStyle={{ background: 'transparent', borderRadius: '15px' }}
